EMS Tracking API - Node.js
================================
Use Node.js to track EMS shipments with EMS Tracking API.
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "EV046445981CN","courier_code"=>"ems-post"},{"tracking_number" => "ED013441749CV","courier_code"=>"ems-post"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"tracking_numbers" => "EV046445981CN","courier_code"=>"ems-post"}
      # params  = {"tracking_numbers" => "EV046445981CN,ED013441749CV","courier_code"=>"ems-post"}
...
Update a tracking by ID:
    ...
    begin
      ...
      id_string = '9dc05c81388cfb2e64fbc6ed4f14c1dc'
