EMS Tracking API - Java
================================
Use Java to track EMS shipments with EMS Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.emspost;
    ...
    public class CreateEMSTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("EB809059138CN");
                createTrackingParams.setCourierCode("ems-post");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateEMSTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("EV046445981CN");
                createTrackingParams1.setCourierCode("ems-post");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("ED013441749CV");
                createTrackingParams2.setCourierCode("ems-post");
...
Get status of the shipment:
    ...
    public class GetEMSTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("EV046445981CN,ED013441749CV");
                trackingParams.setCourierCode("ems-post");
...
Update a tracking by ID:
    ...
    public class UpdateEMSTrackingExample {
